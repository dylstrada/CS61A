...
;;;
;;; To run tests, enter: python3 scheme.py tests.scm
;;;
;;; **********************************
;;; *** Add more of your own here! ***
;;; **********************************

(define moo (mu (oo) (* oo aa)))
; expect moo

(define baa (lambda (oo aa) (moo (/ oo aa))))
; expect baa
...
(define (mul x y)
  (if (= 0 y) 0 (+ x (mul x (- y 1))))
)
(mul 3)
; expect Error: Arguments and parameters length mismatch

(mul 12 12)
; expect 144

(define (f x) 2 2 4 1 3)
; expect f

f
; expect (lambda (x) 2 2 4 1 3)
...
((lambda (plus two minus four one) (plus two two) (minus four one)) + 2 - 4 1)
; expect 3

(lambda (lamb-da) lamb-da)
; expect (lambda (lamb-da) lamb-da)

(begin ())
; expect ()

(begin (begin (begin (begin (begin 2) 2) 4) 1) 3)
; expect 3

(begin 2 2 4 1 3 (print '(Two plus two is four minus one thats three quick maths)))
; expect (two plus two is four minus one thats three quick maths)
